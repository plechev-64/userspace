...
<div class="usp-card usp-masonry">
    <div class="usp-card__head usp-masonry__head usps__relative">
        <img class="usps__img-reset usps__fit-cover" src="<?php echo usp_get_user_cover( $user_id, $avatar_cover = 1 ); ?>">
    ...
    <div class="usp-card__main usps usps__column">
        ...
        <div class="usp-card__center">
            <?php echo usp_get_username( false, usp_get_user_url( $user_id ), [ 'class' => 'usp-card__title' ] ); ?>
