...
class USP_Field_Runner extends USP_Field_Abstract {
	...
	function get_input() {
		...
		$content = '<div id="usp-runner-' . $this->rand . '" class="usp-runner usp-runner-' . $this->rand . '">';

		$content .= '<span class="usp-runner-value"><span></span>';
		if ( $this->unit )
			$content .= ' ' . $this->unit;
		$content .= '</span>';

		$content .= '<div class="usp-runner-box"></div>';
