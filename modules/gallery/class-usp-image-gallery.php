...
class USP_Image_Gallery {
			...
			jQuery(document).ready(function ($) {
				...
				function usp_scale_slider() {
					...
					if (containerWidth) {
						...
						window.setTimeout(usp_scale_slider, 30);
					}
				}

				usp_scale_slider();

				//$Jssor$.$AddEvent(window, "load", usp_scale_slider);
				//$Jssor$.$AddEvent(window, "resize", usp_scale_slider);
				//$Jssor$.$AddEvent(window, "orientationchange", usp_scale_slider);
	...
	function get_navigator_arrows() {
		...
		<div data-u="arrowright" class="usp-navigator-arrow" style="width:40px;height:40px;top:123px;right:8px;" data-autocenter="2" data-scale="0.75" data-scale-right="0.75">
			<svg viewBox="0 0 16000 16000" style="position:absolute;top:0;left:0;width:100%;height:100%;">
