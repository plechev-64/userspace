...
class Widget_new_author extends WP_Widget {
	function __construct() {
		$widget_ops  = array(
			'classname'   => 'usp-new-users',
			'description' => __( 'New users on website', 'userspace' )
		);
	...
	function form( $instance ) {
        ...
        <p>
            <label for="<?php echo $this->get_field_id( 'title' ); ?>"><?php _e( 'Number of displayed users', 'userspace' ); ?>
                :</label>
            <input id="<?php echo $this->get_field_id( 'count_user' ); ?>"
                   name="<?php echo $this->get_field_name( 'count_user' ); ?>"
                   value="<?php echo $instance['count_user']; ?>" style="width:100%;"/>
        </p>
		<?php
		$args = array(
...
class Widget_online_users extends WP_Widget {
	function __construct() {
		$widget_ops  = array(
			'classname'   => 'usp-online-users',
			'description' => __( 'Online users output', 'userspace' )
		);
...
class Widget_author_profil extends WP_Widget {
	function __construct() {
		$widget_ops  = array(
			'classname'   => 'usp-primary-panel',
			'description' => __( 'Block with main profile information', 'userspace' )
		);
