...
add_shortcode( 'usp-users', 'usp_users_shortcode' );
/**
 * Builds shortcode output to display registered users.
 *
 * Example: [usp-users number="24" pagenavi="1" orderby="date_action" search="1" custom_data="posts,comments,user_registered"]
 *
 * @param   $args       array       Additional settings:
 * <pre>
 * $args['number']      int         Set users per page.
 *                                  Default: 10
 ...
 *                                  Allowed: ASC|DESC
 *                                  Default: DESC
 * $args['template']    string      User list output template.
 *                                  Allowed: rows|mini|masonry
 *                                  Default: rows
 * $args['search']      int         Search form at the top.
 *                                  Allowed: 0|1
 *                                  Default: 0
 ...
 * $args['online_only'] int         See who online (set "1").
 *                                  Default: null
 * </pre>
 *
...
/**
 * Builds shortcode output list of last registered users.
 *
 * Example: [usp-users-new number="9"]
 *
 * @param   $args       array   Additional settings:
 * <pre>
 * $args['number']      int     Set users per page.
 *                              Default: 12
 * $args['template']    string  Output template.
 *                              Allowed: mini|rows|masonry
 *                              Default: mini
 * </pre>
 *
 * @return string       HTML content to display last registered users.
 * @since               1.0.0
 *
 */
...
/**
 * Builds shortcode output last online users.
 *
 * Example: [usp-users-online number="9"]
 *
 * @param   $args       array   Additional settings:
 * <pre>
 * $args['number']      int     Set users per page.
 ...
 * </pre>
 *
 * @return string       HTML content to display last online users.
 * @since               1.0.0
 *
 */
