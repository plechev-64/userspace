...
function usp_options_manager_scripts() {
	wp_enqueue_style( 'usp-options-manager', USP_URL . 'src/Module/options-manager/assets/css/usp-options-manager.css' );
	wp_enqueue_script( 'usp-options-manager', USP_URL . 'src/Module/options-manager/assets/js/usp-options-manager.js' );
}
