...
if ( $GLOBALS['pagenow'] === 'wp-login.php' ) {
	wp_enqueue_style( 'usp-wploginform', USP_URL . 'src/Module/loginform/assets/css/usp-loginform-wp-login.css' );
...
function usp_loginform_assets() {
	...
	usp_enqueue_style( 'usp-entryform', USP_URL . 'src/Module/loginform/assets/css/usp-loginform.css', false, false, true );
	usp_enqueue_script( 'usp-entryform', USP_URL . 'src/Module/loginform/assets/js/usp-loginform.js', false, false, true );
}
