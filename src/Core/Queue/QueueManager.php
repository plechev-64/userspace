...
class QueueManager {
    ...
    public function __construct( ContainerInterface $container, QueueStatus $status, array $messageHandlerMap ) {
    ...
    public function processQueueBatch(): void {
        ...
        while ( time() - $start_time < $safe_time_limit ) {
            $job_processed = $this->processSingleJob();
     ...
     */
    public function processSingleJob(): bool {
        global $wpdb;
