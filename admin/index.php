...
function usp_admin_sidebar_about_notice( $content ) {
    ...
    $content .= usp_get_notice( [ 'text' => 'UserSpace - ' . $text['description'], 'type' => 'simple', 'icon' => false, 'cookie' => 'usp_userspace_about' ] );
...
function usp_admin_sidebar_rate_me_notice( $content ) {
    ...
    $content .= usp_get_notice( [ 'text' => $text, 'type' => 'simple', 'icon' => false, 'cookie' => 'usp_repo_votes' ] );
