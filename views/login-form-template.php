...
<form name="loginform" class="usp-form" id="loginform" action="<?php echo esc_url( site_url( 'wp-login.php', 'login_post' ) ); ?>" method="post" data-usp-form="login">
	<div class="usp-form-wrapper">
		...
		<div class="usp-form-field-wrapper usp-form-field-rememberme">
			<label><input name="rememberme" type="checkbox" id="rememberme" value="forever"> <?php _e( 'Remember Me', 'usp' ); ?></label>
		</div>
		<div class="usp-form-submit-wrapper">
			<input type="hidden" name="redirect_to" value="<?php echo esc_url( $redirect_to ); ?>" />
			<button type="submit" name="wp-submit" id="wp-submit" class="button button-primary"><?php _e( 'Log In', 'usp' ); ?></button>
		</div>
	</div>
</form>
